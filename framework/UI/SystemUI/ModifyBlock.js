...
class ModifyBlock extends BaseView {
  ...
  startDrawing(parent) {
    ...
    let inputEle = document.querySelector(".picker-input > input");
    let opacityInput = document.querySelector(".picker-opacity-input");
    ...
    function updatePreviewColor() {
      const colorPreview = document.querySelector(".pcr-button");
